...
func (a Alert) Normalize() (*Alert, error) {
	...
	err := validate.Many(
		...
		validate.OneOf("Source", a.Source, SourceManual, SourceGke, SourceGrafana, SourceSite24x7, SourcePrometheusAlertmanager, SourceEmail, SourceGeneric, SourceUniversal),
